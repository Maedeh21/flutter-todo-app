...
void main() {
  ...
  test("create account", () async {
    when(
      mockFirebaseAuth.createUserWithEmailAndPassword(
          email: "new@yahoo.com", password: "123456"),
    ).thenAnswer((realInvocation) => null);

    expect(
        await auth.createAccount(email: "new@yahoo.com", password: "123456"),
        "Success");
  });
  ...
  test("sign in", () async {
    ...
    expect(await auth.signIn(email: "new@yahoo.com", password: "123456"),
        "Success");
  });
